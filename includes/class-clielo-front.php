    ...
    public static function render_options_card( array $args = [] ): string {
        ...
        <div id="clielo-sc-card" style="font-family:'Inter',-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif !important;border:1px solid #e0e0e0 !important;border-radius:var(--clielo-card-radius) !important;overflow-x:hidden !important;overflow-y:auto !important;max-height:calc(100vh - 80px) !important;background:var(--clielo-card-bg) !important;box-shadow:0 2px 8px rgba(0,0,0,0.06) !important;max-width:100% !important;padding:0 !important;margin:0 0 20px 0 !important">
            ...
            <div id="clielo-sc-footer" style="padding:14px 16px !important;border-top:2px solid var(--clielo-footer-border) !important;background:var(--clielo-footer-bg) !important;margin:0 !important;border-radius:0 0 var(--clielo-card-radius) var(--clielo-card-radius) !important">
                ...
                <button type="button" id="clielo-sc-quote" style="display:flex !important;align-items:center !important;justify-content:center !important;gap:8px !important;width:100% !important;padding:10px !important;border:1px solid var(--clielo-quote-btn-border, var(--clielo-btn-bg)) !important;border-radius:var(--clielo-quote-btn-radius, var(--clielo-btn-radius)) !important;background:var(--clielo-quote-btn-bg, transparent) !important;color:var(--clielo-quote-btn-color, var(--clielo-btn-bg)) !important;font-size:13px !important;font-weight:600 !important;cursor:pointer !important;font-family:inherit !important;margin:6px 0 0 !important;line-height:1.4 !important">
            ...
            <?php if ( $is_logged ) : ?>
                <form id="clielo-form" class="clielo-form" onsubmit="return false;">
                    ...
                    <div id="clielo-input-wrapper" class="clielo-input-wrapper">
                        ...
                        <button type="button" id="clielo-attach-btn" title="<?php esc_attr_e( 'Envoyer une image', 'clielo' ); ?>" style="background:none;border:none;cursor:pointer;padding:4px 6px;color:#9ca3af;flex-shrink:0;display:flex;align-items:center;justify-content:center;align-self:center">
                        ...
                        <button type="button" id="clielo-mic-btn" title="<?php esc_attr_e( 'Message vocal', 'clielo' ); ?>" style="background:none;border:none;cursor:pointer;padding:4px 6px;color:#9ca3af;flex-shrink:0;display:flex;align-items:center;justify-content:center;align-self:center">
