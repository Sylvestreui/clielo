            ...
            <?php if ( $is_logged ) : ?>
                <form id="clielo-form" class="clielo-form" onsubmit="return false;">
                    ...
                    <div id="clielo-input-wrapper" class="clielo-input-wrapper">
                        ...
                        <button type="button" id="clielo-attach-btn" title="<?php esc_attr_e( 'Envoyer une image', 'clielo' ); ?>" style="background:none;border:none;cursor:pointer;padding:4px 6px;color:#9ca3af;flex-shrink:0;display:flex;align-items:center;justify-content:center;position:relative;bottom:10px">
                        ...
                        <button type="button" id="clielo-mic-btn" title="<?php esc_attr_e( 'Message vocal', 'clielo' ); ?>" style="background:none;border:none;cursor:pointer;padding:4px 6px;color:#9ca3af;flex-shrink:0;display:flex;align-items:center;justify-content:center;position:relative;bottom:10px">
